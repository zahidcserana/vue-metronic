              ...
              <div class="col-xl-4">
                ...
                <div class="row m-row--full-height">
                  <div class="col-sm-12 col-md-12 col-lg-6">
                    <div
                      class="m-portlet m-portlet--half-height m-portlet--border-bottom-brand m-portlet--rounded"
                    >
                    ...
                    <div
                      class="m-portlet m-portlet--half-height m-portlet--border-bottom-danger m-portlet--rounded"
                    >
                      <div class="m-portlet__body">
                        <div class="m-widget26">
                          <div class="m-widget26__number">
                  ...
                  <div class="col-sm-12 col-md-12 col-lg-6">
                    <div
                      class="m-portlet m-portlet--half-height m-portlet--border-bottom-success m-portlet--rounded"
                    >
                      <div class="m-portlet__body">
                        <div class="m-widget26">
                          <div class="m-widget26__number">
                    ...
                    <div class="m--space-30"></div>
                    <div
                      class="m-portlet m-portlet--half-height m-portlet--border-bottom-accent m-portlet--rounded"
                    >
                      <div class="m-portlet__body">
                        <div class="m-widget26">
                          <div class="m-widget26__number">
                  ...
                  <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                      <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Finance Summary</h3>
                      </div>
                    </div>
                  ...
                  <div class="m-portlet__body">
                    <div class="tab-content">
                      <div class="tab-pane active">
                        <div
                          class="m-widget12 m-widget12--chart-bottom m--margin-top-10"
                            ...
                            <div class="m-widget12__text2">
                              ...
                              <div class="m-widget12__progress">
                                <div class="m-widget12__progress-sm progress m-progress--sm">
                                  <div
                                    class="m-widget12__progress-bar progress-bar bg-brand"
                                    role="progressbar"
                                    aria-valuenow="25"
                                    aria-valuemin="0"
                                    aria-valuemax="100"
                                ...
                                <span class="m-widget12__stats">63%</span>
                              </div>
                            </div>
                          </div>
              ...
              <div class="col-xl-4">
                ...
                <div class="m-portlet m-portlet--full-height m-portlet--fit m-portlet--rounded">
                  <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                      <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Top Products</h3>
                      </div>
                    </div>
                    <div class="m-portlet__head-tools">
                    ...
                    <div class="m-widget4 m-widget4--chart-bottom" style="min-height: 480px">
                      <div class="m-widget4__item">
                        ...
                        <div class="m-widget4__info">
                          <span class="m-widget4__title">Phyton</span>
                          <br />
                          <span class="m-widget4__sub">A Programming Language</span>
                        </div>
                      ...
                      <div class="m-widget4__item">
                        ...
                        <div class="m-widget4__info">
                          <span class="m-widget4__title">FlyThemes</span>
                          <br />
                          <span class="m-widget4__sub">A Let's Fly Fast Again Language</span>
                        </div>
                        <span class="m-widget4__ext">
                      ...
                      <div class="m-widget4__item">
                        ...
                        <div class="m-widget4__info">
                          <span class="m-widget4__title">Starbucks</span>
                          <br />
                          <span class="m-widget4__sub">Good Coffee & Snacks</span>
                        </div>
                        <span class="m-widget4__ext">
                          <span class="m-widget4__number m--font-brand">+$300</span>
                        </span>
                      ...
                      <div
                        class="m-widget4__chart m-portlet-fit--sides m--margin-top-20"
                        style="height:260px;"
                      >
                            ...
                            <table class="table">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <span class="m-widget11__title">Management</span>
              ...
              <div class="col-xl-4">
                ...
                <div class="m-portlet m-portlet--full-height m-portlet--fit m-portlet--rounded">
                  <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                      <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">Latest Updates</h3>
                      </div>
                    </div>
                    <div class="m-portlet__head-tools">
                      <ul class="m-portlet__nav">
                  ...
                  <div class="m-portlet__body">
                    <div class="m-widget4 m-widget4--chart-bottom" style="min-height: 350px">
                      <div class="m-widget4__item">
                        ...
                        <div class="m-widget4__info">
                          <span class="m-widget4__text">Make Management Great Again</span>
                        </div>
                        <div class="m-widget4__ext">
                      ...
                      <div class="m-widget4__item">
                        ...
                        <div class="m-widget4__info">
                          <span class="m-widget4__text">Green Maker Team</span>
                        </div>
                        <div class="m-widget4__ext">
                      ...
                      <div class="m-widget4__item">
                        ...
                        <div class="m-widget4__info">
                          <span class="m-widget4__text">Make Apex Great Again</span>
                        </div>
                        <div class="m-widget4__ext">
                          <span class="m-widget4__stats m--font-info">
                      ...
                      <div class="m-widget4__item m-widget4__item--last">
                        ...
                        <div class="m-widget4__info">
                          <span class="m-widget4__text">A Programming Language</span>
                        </div>
                        <div class="m-widget4__ext">
                          <span class="m-widget4__stats m--font-info">
                          ...
                          <div class="m-timeline-3__items">
                            <div class="m-timeline-3__item m-timeline-3__item--info">
                              ...
                              <div class="m-timeline-3__item-desc">
                                <span
                                  class="m-timeline-3__item-text"
                                >Lorem ipsum dolor sit amit,consectetur eiusmdd tempor</span>
                                <br />
                            ...
                            <div class="m-timeline-3__item m-timeline-3__item--brand">
                              ...
                              <div class="m-timeline-3__item-desc">
                                <span
                                  class="m-timeline-3__item-text"
                                >Lorem ipsum dolor sit consectetur eiusmdd tempor</span>
                                <br />
                                <span class="m-timeline-3__item-user-name">
                                  <a
                                    href="#"
                          ...
                          <div class="m-timeline-3__items">
                            ...
                            <div class="m-timeline-3__item m-timeline-3__item--success">
                              ...
                              <div class="m-timeline-3__item-desc">
                                <span
                                  class="m-timeline-3__item-text"
                                >The standard chunk of Lorem Ipsum used since the 1500s is reproduced.</span>
                                <br />
                                <span class="m-timeline-3__item-user-name">
                                  <a
                                    href="#"
                            ...
                            <div class="m-timeline-3__item m-timeline-3__item--danger">
                              ...
                              <div class="m-timeline-3__item-desc">
                                <span
                                  class="m-timeline-3__item-text"
                                >Latin words, combined with a handful of model sentence structures.</span>
                                <br />
                                <span class="m-timeline-3__item-user-name">
                                  <a
                                    href="#"
                            ...
                            <div class="m-timeline-3__item m-timeline-3__item--brand">
                              ...
                              <div class="m-timeline-3__item-desc">
                                <span
                                  class="m-timeline-3__item-text"
                                >Lorem Ipsum is therefore always free from repetition, injected humour.</span>
                                <br />
                                <span class="m-timeline-3__item-user-name">
                                  <a
                                    href="#"
...
export default {
  ...
  mounted () {
    ...
    recaptchaScript.setAttribute('src', 'assets/app/js/dashboard.js')
